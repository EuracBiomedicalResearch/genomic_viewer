## Function for reading data tables and visualize them in the "Data" tabset of
## plotgardenere Shiny app:

shiny_read_table_function <- function(bed.file,
                                      bedpe.file,
                                      cat.file,
                                      gwas.file,
                                      chr,
